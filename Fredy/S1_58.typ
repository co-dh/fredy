...
`xy` means first `x` then `y`. Companion to `Fredy/S1_58.lean` (`image_via_coeq`, §1.581
...
is exactly `image_via_coeq` (`Fredy/S1_58.lean`): `Mono (hcoeq.desc x kp_sq)`.
...
(`Fredy/S1_58.lean`), whose proof runs exactly these steps (`image.lift`,
