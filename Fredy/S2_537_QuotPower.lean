...
import Fredy.S2_5_QuotAllegory   -- QuotAllegory, quotRep, instAllegory/instDistributiveAllegory
import Fredy.S2_51_QuotPreserve  -- quotRep_preserves_tabular (discharges §2.51 quotient-tabularity)
