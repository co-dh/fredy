/-
  ...
  `Fredy/L169.lean` WRITES the voting fold by hand as a raw `List.foldl`:
  ...
  machinery here), so — following the reshaping recipe (`Fredy/A6_GenFold.lean`, as in
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L169.lean`
