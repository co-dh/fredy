/-
  ...
  `Fredy/L100.lean` WRITES the two-input recursion `sameFn : Tree Int → Tree Int → Bool` by hand and
  ...
  `TB.treeFold_unique` (`Fredy/A6_GenFold.lean`) — the same law's `C = C₁ × C₂` instance is the
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L100.lean`
