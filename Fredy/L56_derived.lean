/-
  ...
  `Fredy/L56.lean` writes `mergeFn = mergeSorted ∘ isort` over a RAW Lean `List (Int × Int)`:
  ...
  re-proved.  Uses the SHARED `Freyd.Alg.RelSet.CL.ofList` (`Fredy/A6_ConsList.lean`).
