...
theorem coproduct_inj_monic [Topos 𝒞] (hca : HasAllCoproducts 𝒞)
    {I : Type v} {A : I → 𝒞} (cop : Coproduct A) (k : I) : Mono (cop.inj k) := by
  classical
...
private theorem pfcInj_monic (i : I) : Mono (pfcInj hca A i) :=
...
theorem cfpEmbed_monic {I : Type v} (A : I → 𝒞) (i : I) : Mono (cfpEmbed hp A i) := by
  intro W u v huv
