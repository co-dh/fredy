/-
  ...
  `Fredy/L111.lean` WRITES the three-way min-depth fold `minDepthFn : Tree Int → Nat` by hand
  ...
  `TB.treeFold_unique` (`Fredy/A6_GenFold.lean`) PRODUCES the catamorphism
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L111.lean` -/
