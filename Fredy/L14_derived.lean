/-
  ...
  `Fredy/L14.lean` computes the longest common prefix by folding `commonPrefix2` right-to-left over
  ...
  (`Fredy/A6_GenFold.lean`) PRODUCES the fold as `cataR (consScalarAlg g st)` — it is never written
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L14.lean`
