/-
  ...
  `Fredy/L617.lean` WRITES the two-input recursion `mergeT : Tree Int → Tree Int → Tree Int` by hand
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L617.lean`
