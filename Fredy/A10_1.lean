/-
  ...
  drop note at the end of `Fredy.A9_1`.

  Setting: `UnguardedPowerLCDA` (`Fredy.A6_2`), continuing chapters 7-9.
-/
import Fredy.A9_1
...
/-! ## B&dM p.246 — the greedy hypotheses via a bifunctor (recall of Proposition 9.4)
  ...
  B&dM close §10.1 by recalling Proposition 9.4 (`Fredy.A9_1`'s `Birelator` infra): the
