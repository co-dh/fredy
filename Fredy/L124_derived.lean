/-
  ...
  `Fredy/L124.lean` WRITES the pair-carrying fold `foldFn = (best, gain)` by hand and then verifies
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L124.lean`
