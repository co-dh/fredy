/-
  ...
  Same recipe as `Fredy/L121.lean`/`Fredy/L53.lean` (see `Fredy/leetcode.md`), but a MIN-extremum
  (like the greedy theorem 7.2, `Fredy/A7_2.lean`) rather than a max-extremum:
