/-
  ...
  `Fredy/L404.lean` WRITES the naive program `sumLL : Tree Int → Bool → Int` by hand — a leaf-checking
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L404.lean`
