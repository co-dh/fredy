/-
  ...
  `Fredy/L55.lean` writes the greedy scan `foldFn : SnocList Nat Nat → Nat × Bool` (state
  ...
  (`Fredy/A6_GenFold.lean`) — the "any carrier `C`" generalisation of `tupling`.
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L55.lean`
