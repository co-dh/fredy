/-
  ...
  `Fredy/L98.lean` WRITES the bounds scan `within : Option Int → Option Int → Tree Int → Bool` by
  ...
  general-carrier fold-uniqueness law `TB.treeFold_unique` (`Fredy/A6_GenFold.lean`) — the same law
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L98.lean`
