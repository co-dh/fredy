/-
  ...
  `Fredy/L11.lean` writes the two-pointer sweep `twoPtrFuel` over a `List Int`, tamed with an explicit
  ...
  `Hylo.hyloFold_unique` (`Fredy/A6_GenHylo.lean`) is the uniqueness law: any function `h` obeying
