/-
  ...
  `Fredy/L231.lean` decides the property by `pow2Fuel fuel m`, recursing on a separate FUEL
  ...
  `Hylo.hyloFold_unique` (`Fredy/A6_GenHylo.lean`) — the dual of the fold-uniqueness laws, for a
