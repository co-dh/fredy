/-
  ...
  `Fredy/L238.lean` WRITES `solveFn nums = zipWith (·*·) (prefixProducts nums) (suffixProducts
  ...
  law `CL.consFold_unique` (`Fredy/A6_GenFold.lean`), with two DIFFERENT carrier shapes:
