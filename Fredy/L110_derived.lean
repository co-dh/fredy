/-
  ...
  `Fredy/L110.lean` WRITES the pair-carrying fold `foldFn = (height, balanced)` by hand and then
...
/-! ## Running / cross-checking the emergent fold against `Fredy/L110.lean`
...
/-- The derived answer agrees with `L110.solveFn` on every example tree of `Fredy/L110.lean`. -/
