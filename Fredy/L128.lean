/-
  ...
  Same recipe as `Fredy/L56.lean`/`Fredy/L435.lean` (`Fredy/leetcode.md` S0/S22/S24): the data
  object is a plain `List Int`, and we REUSE `Fredy.L242`'s hand-rolled insertion sort
