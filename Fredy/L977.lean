/-
  ...
  Same recipe as `Fredy/L56.lean`/`Fredy/L242.lean` (`Fredy/leetcode.md` S0/S22/S24/S28): the data
  ...
  `Fredy.L242`'s hand-rolled insertion sort verbatim (as `L128`'s `longestConsecFn` already reuses
