/-
  ...
  `leet/L572.lean` WRITES `sameFn`/`subFn` by hand and verifies them by structural induction. HERE
  both folds EMERGE from `TB.treeFold_unique` (`AOP/A6_GenFold.lean`, the general-carrier tree
...
/-! ## Running / cross-checking the emergent folds against `leet/L572.lean`
