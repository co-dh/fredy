/-
  ...
  `leet/L367.lean` writes `sqFuel` as a FUEL-indexed upward search: search from `k = 0`,
  ...
  every recursive step (`Hylo.hyloFold_unique`, `AOP/A6_GenHylo.lean` — the law `L21_derived`
