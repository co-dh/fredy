/-
  ...
  `leet/L62.lean` WRITES the DP by hand: `rowAt m n` folds `m` copies of `stepRow` (a prefix-sum
  ...
  `Freyd.Alg.RelSet.SL.snocFold_unique` (`AOP/A6_GenFold.lean`), exactly as `L300_derived` /
...
/-! ## Running / cross-checking the emergent fold against `leet/L62.lean`
