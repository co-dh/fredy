/-
  ...
  `leet/L101.lean` WRITES the two-input crosswise-mirror recursion `mirrorFn : Tree Int → Tree Int →
...
/-! ## Running / cross-checking the emergent fold against `leet/L101.lean`
