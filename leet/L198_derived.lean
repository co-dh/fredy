/-
  ...
  `leet/L198.lean` WRITES the pair-carrying DP fold `foldFn` (state `(best, prevBest)`) by hand and
  verifies it by induction (`cataFold_alg`, `solve_eq_cata`).  This file makes that fold EMERGE from
  the reusable tupling / linearization law `Freyd.Alg.RelSet.SL.tupling` (`AOP/A6_8_Tupling.lean`),
  exactly as `leet/L70_derived.lean` (Fibonacci) and `leet/L1137_derived.lean` (Tribonacci) do.
...
/-! ## Running / cross-checking the emergent fold against `leet/L198.lean`
