/-
  ...
  `leet/L9.lean` extracts the digit sequence with a FUEL-guarded value-recursion,
  ...
  `Hylo.hyloFold_unique` (`AOP/A6_GenHylo.lean`) is the uniqueness law: any function `h`
