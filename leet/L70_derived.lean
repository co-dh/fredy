/-
  ...
  Unlike `leet/L70.lean` (which WRITES the pair-carrying fold `fibPair` by hand and then verifies
  ...
  (`AOP/A6_8_Tupling.lean`) linearizes it:
...
/-! ## Running / cross-checking the emergent fold against `leet/L70.lean`
