/-
  ...
  `leet/L230.lean` WRITES the inorder traversal `inorder : Tree Int → List Int` by hand
  ...
  general-carrier fold-uniqueness law `TB.treeFold_unique` (`AOP/A6_GenFold.lean`), instantiated at
...
/-! ## Running / cross-checking the emergent fold against `leet/L230.lean` -/
