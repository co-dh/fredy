/-
  ...
  `leet/L338.lean` builds `[popcount 0, …, popcount n]` by hand with a `List Nat` accumulator whose
  ...
  `Freyd.Alg.RelSet.SL.snocFold_unique` (`AOP/A6_GenFold.lean`) PRODUCES the fold as
