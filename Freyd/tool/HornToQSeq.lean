/-
  ...
  `Freyd/HornDiagram.lean` gives the *syntactic* iso `Horn ≅ Diagram` (strings) and the
  Typst renderer.  But the repo's `QSeq` (`Freyd/S1_38b.lean`) is *semantic*: a telescope
...
import Freyd.S1_38b   -- QSeq, Satisfies, QSeq.complement, satisfies_*, IsIso, Cat
