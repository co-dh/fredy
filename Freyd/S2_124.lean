/-
  ...
  The companion note `Freyd/S2_124.typ` proves  `Dom(R ∩ S) = 1 ∩ S R°`  graphically: it rewrites BOTH
  ...
  (which does use the modular law) is `Freyd.S2_1.dom_inter`.  A purely point-free Lean *derivation*
...
/-- **§2.124 in `Rel`.**  `1 ∩ S R° = Dom (R ∩ S)`, obtained by driving both sides to the normal form
    `W`.  (Abstract allegory version, via the modular law: `Freyd.S2_1.dom_inter`.) -/
